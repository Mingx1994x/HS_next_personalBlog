    ...
    <div className="blog-select-swiper">
      ...
      >
        {selectBlogsData.map((blogData) => (
          <SwiperSlide key={blogData.id} className="h-auto">
            <BlogCard cardData={blogData} />
          </SwiperSlide>
        ))}
      </Swiper>
      <div className="swiper-button-area">
        <div className="swiper-button-prev" ref={buttonPrevRef}></div>
        <div className="swiper-button-next" ref={buttonNextRef}></div>
      </div>
    </div>
  );
}
