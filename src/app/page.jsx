...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="container">
        <div className="section-spacing">
            ...
            {serviceCardsData.map((data, index) => {
              return (
                <ServiceCard
                  ...
                  cardData={data}
                  isLastOne={
                    index === serviceCardsData.length - 1 ? true : false
                  }
                />
              );
            })}
          ...
          <div className="d-flex flex-column flex-md-row align-items-end align-items-md-center justify-content-md-end">
            ...
            <button
              type="button"
              className="btn btn-lg circle-arrow-btn btn-outline-secondary"
            >
      ...
      {/* 部落格精選 */}
      <section className="container">
        <div className="blogSelect section-spacing">
      ...
      <section className="container">
        <div className="section-spacing">
          <h2 className="display-main-title mb-6 d-none d-md-block">
            職涯諮詢成功案例
          </h2>
          <h2 className="display-main-title mb-6 d-md-none">
            職涯諮詢
            <br />
            成功案例
          </h2>
            ...
            <div className="col-md-5">
              <div className="consult-card">
                <div className="consult-wrapper slide-left-down">
                  <p className="consult-text-spacing">
                ...
                <div className="consult-wrapper bg-neutral-200 slide-up">
                  <p className="consult-text-spacing mb-6">
                    期待在下一個新機會中，我能與你一起攜手邁向更高峰！
                  </p>
                  <button
                    type="button"
                    className="btn btn-lg pill btn-outline-primary fw-bold"
                  >
                    立即預約諮詢
                  </button>
                </div>
